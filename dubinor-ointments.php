...
<div class="page-content">
    <div id="content">
        ...
        <div id="bg" class="dubinor-ointments">
            <img src="assets/img/stalls/dubinor_oinments.jpg">
            <div id="back-button">
                <a href="exhibitionhalls.php"><i class="fas fa-arrow-alt-circle-left"></i> Back</a>
            </div>
            <a href="assets/resources/dubinor-ointments_1.jpg" id="poster1" class="view">
                <div class="indicator d-6"></div>
            </a>
            <a href="assets/resources/dubinor-ointments_2.jpg" id="poster2" class="view">
                <div class="indicator d-6"></div>
            </a>
