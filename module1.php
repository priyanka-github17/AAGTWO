...
$exhib_id = '3878b0367bcc13b401ff33c4de38de55d05f3cded559174a675da26a84e177dd';
...
<video id="myVideo" width="900" height="500" controls>
    ...
    <video id="myVideo"  style="width: 100%;height: auto;" controls controlsList="nodownload" disablePictureInPicture>
      ...
      <source src="https://player.vimeo.com/progressive_redirect/playback/729187044/rendition/720p/file.mp4?loc=external&signature=fc937a39f05bcf8e593b5c7b2377c2209fdbb0c2efee5507f50d6a9311483c48" type="video/mp4" />
  ...
  <div class="col-md-8">
    ...
    <div class="row">
      ...
      <div class="course-name-hld ml-2">
          ...
          <div>
              <span class="course-name mb-4">PHYSIOLOGY OF THE MENSTRUAL CYCLE</span>
          ...
          <!-- <div class="course-social-hld text-right ">
                    ...
                    <div id="toggle">
                        <!-- <p>Note:</p> -->
                        <p dir="ltr">Module 1 will take you in depth on the phases of normal menstrual cycle, right from follicular phase, folliculogenesis, pre-ovulatory period, ovulation, luteal phase, hormonal profile during the menstrual cycle, female sexual cycle, endometrial changes during the menstrual cycle, menstruation, and role of hypothalamus in menstrual cycle.</p>
