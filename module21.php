...
//         header('location: auditorium2.php');
//     }
...
<div>
    ...
    <a href="./quizfile/pretest2.php"><button class="cmeFormButton mb-2 mr-2"  id="btn1"  data-modal="enroll-with-login">CONTINUE</button></a> 
    <!-- <a href="./quizfile/posttest2.php"><button class="cmeFormButton btn mb-2 mr-2"  id="btn1"  data-modal="enroll-with-login"> Next Post Test </button></a>  -->
</div>
