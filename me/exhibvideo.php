    ...
    <div class="col-12 col-md-6 offset-md-3">
      ...
      <?php if ($_GET['ac'] == 'add') { ?>
        <form method="post" action="" class="form">
          ...
          <div class="form-group">
            <input type="text" name="videoTitle" id="videotitle" class="form-control" value="<?= $video_title ?>" placeholder="Enter Video Title">
          </div>
          <div class="form-group">
            <input type="text" name="videoUrl" id="videoUrl" class="form-control" value="<?= $video_url ?>" placeholder="Enter Video URL">
          </div>
          <div class="form-group">
            <button class="btn btn-primary" type="submit" name="btn-addvideo">Add Video</button>
          </div>
        </form>
      <?php }
      if ($_GET['ac'] == 'edit') { ?>
