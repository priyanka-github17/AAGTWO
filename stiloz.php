...
<div class="page-content">
    <div id="content">
        ...
        <div id="bg" class="stiloz">
            <img src="assets/img/stalls/stiloz.jpg">
            <div id="back-button">
                <a href="exhibitionhalls.php"><i class="fas fa-arrow-alt-circle-left"></i> Back</a>
            </div>
            <a href="assets/resources/stiloz_1.jpg" id="poster1" class="view">
                <div class="indicator d-6"></div>
            </a>
            <a href="assets/resources/stiloz_2.jpg" id="poster2" class="view">
                <div class="indicator d-6"></div>
            </a>
