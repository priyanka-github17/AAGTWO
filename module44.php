      ...
      <div class="col-md-12">
        ...
        <div class="course-name-hld ml-2">
          ...
          <div>
              ...
              <a href="https://coact.live/AllAboutGestation/quizfile/pretest5.php"><button class="cmeFormButton mb-2 mr-2"  id="btn1"  data-modal="enroll-with-login">CONTINUE</button></a> 
