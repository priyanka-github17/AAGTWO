...
<div class="page-content">
    <div id="content" class="photobooth">
        ...
        <div id="bg" class="photobooth">
            <img src="https://origyn.s3.ap-south-1.amazonaws.com/photobooth.jpg">
        </div>
        <div id="photobooth">
            <div id="cam-panel-2" class="camera-panel">
                ...
                <div style="height: 338px; overflow: hidden;">
                    <div class="photo-jacket-container-2">
                        <img class="photo-jacket" src="assets/img/booth-directors.png" />
                        <div id="cam-ui-2">
                            <div id="cam-feed">
            ...
            <div id="options-2">
                ...
                <ul class="list-unstyled">
                    <li>
                        <a href="photobooth.php"> Take Selfie</a>
                    </li>
                </ul>
