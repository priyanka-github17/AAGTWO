...
$exhib_id = 'cccc0342e043f6153d5ca7c8d636a7f4bbcf160f7cedb72fabe7f28099a38184';
...
<video id="myVideo" width="900" height="500" controls>
    ...
    <video id="myVideo"  style="width: 100%;height: auto;" controls controlsList="nodownload" disablePictureInPicture>
      ...
      <source src="https://player.vimeo.com/progressive_redirect/playback/723337069/rendition/720p/file.mp4?loc=external&signature=4ae07a14e6fab208003dac502eddf65093b2bcec0c900b6a8b6d772e4063765b" type="video/mp4" />
  ...
  <div class="col-md-8">
    ...
    <div class="row">
      ...
      <div class="course-name-hld ml-2">
          ...
          <div>
              <span class="course-name mb-4">RECURRENT IMPLANTATION FAILURE</span>
              ...
              <a href="https://coact.live/AllAboutGestation/quizfile/posttest4.php"><button class="cmeFormButton btn mb-2 mr-2"  id="btn1"  data-modal="enroll-with-login"> POST ASSESSMENT</button></a> 
          ...
          <!-- <div class="course-social-hld text-right ">
                    ...
                    <div id="toggle">
                        <!-- <p>Note:</p> -->
                        <p dir="ltr">Module 4 will enable learning on Recurrent implantation failure. The topic will be covered in detail, including the following pointers: definition, incidence, etiology, gamete/embryo quality, uterine factors, acquired uterine anomalies, investigations, evaluation of embryo, endometrial receptivity, and management.</p>
