...
<img src="logo-new.png"  width="260px" height="98px" style="float:right"  alt="">
    ...
    <button id="start_quiz" style="background-color:#b30086;">ASSESSMENT 2 - PHYSIOLOGY OF CONCEPTION</button>
</header>
...
<section class="quiz_container">
    <div class="quiz_text">
        <h1>ASSESSMENT 2 - PHYSIOLOGY OF CONCEPTION</h1>
    </div>
...
<article class="result_box">
    ...
    <a href="../module22.php" i><button  class="btn1 mt-3">Re-Watch Module 2</button></a> 
 <!-- <a href="../digital_cert.php"><button  class="btn1">Next Module</button></a>  -->
 <a href="../quizfile/pretest3.php" ><button  class="btn2"  id="myBtn">Module 3 - Luteal Phase Defect</button></a>
 <!-- <a href="#" id="module"><button  class="btn2"  id="myBtn">Module 3 - Luteal Phase Defect</button></a>   -->
 <!-- <a href="https://coact.live/AllAboutGestation/rateing/" id="module1"><button  class="btn2 mt-3">Feedback</button></a>  -->
...
<script>
    const questions = [{
            ...
            'id': 3,
            "question": 'The sperm undergoes ____ in the vagina',
            'Options': [
                'Acrosomal rctn',
                'Capacitation',
                'Cortical reaction',
            ...
            'answer': 'Embryonic Genome Activation'
        }, {
            'id': 7,
            "question": 'Morula is..',
            'Options': [
...
objXMLHttpRequest.send();
   ...
   if(userscore >=500){
    alert("Sucessfully complited module 2");
