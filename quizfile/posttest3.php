...
$exhib_id = 'fbdae8790fca0b289102d6891e8efc9a3c70e3b5181ae5460b4a2aaf72c92c68';
require_once "../exhibcheck.php";
$curr_room = 'posttest_module3';
?>
...
<img src="logo-new.png"  width="260px" height="98px" style="float:right"  alt="">
    ...
    <button id="start_quiz" style="background-color:#b30086;">ASSESSMENT 3 - LUTEAL PHASE DEFECT</button>
</header>
...
<section class="quiz_container">
    <div class="quiz_text">
        <h1>ASSESSMENT 3 - LUTEAL PHASE DEFECT</h1>
    </div>
...
<article class="result_box">
    ...
    <a href="../module33.php" ><button  class="btn1 mt-3">Re-Watch Module 3</button></a> 
 <!-- <a href="../digital_cert.php"><button  class="btn1">Next Module</button></a>  -->
 <a href="../quizfile/pretest4.php"><button  class="btn2"  id="myBtn">Module 4 - Recurrent Implantation Failure</button></a> 
...
24th JUNE 2022 10:00 ONWARDS</p>
 ...
 <a href="../lobby.php"  ><button  class="btn1 mt-3">Home</button></a> 
...
<script>
    const questions = [{
            'id': 1,
            "question": 'Large luteal cells are derived from',
            'Options': [
                'theca interna cells',
                'corpus luteum',
                'granulosa cells',
            ...
            'id': 2,
            "question": 'Luteal insufficiency is related to premature return to estrus or loss of a pregnancy',
            'Options': [
                'true',
                'false',
                'maybe',
            ...
            'id': 3,
            "question": 'Progesterone causes which of the following?',
            'Options': [
                'decreased GnRH pulse amplitude and frequency',
                'essential to stimulate estrus',
                'triggers the preovulatory LH surge',
                'stimulates myometrial contractions'
            ],
            'answer': 'decreased GnRH pulse amplitude and frequency'
        }, {
            'id': 4,
            "question": 'LH phase is depend on which hormone',
            'Options': [
                'estrogen',
                'testosterone',
                'progesterone',
            ...
            'id': 5,
            "question": 'During which phase of the ovarian cycle are progesterone levels the highest ?',
            'Options': [
                'luteal phase',
                'follicular phase',
                'menstrual phase',
            ...
            'id': 6,
            "question": 'Which structure produces the steroid hormone progesterone ?',
            'Options': [
            ...
            'id': 7,
            "question": 'When does ovulation occur during the typical 28 day ovarian cycle?',
            'Options': [
                'day 14',
                'day 5',
                'day 20',
            ...
            'id': 8,
            "question": 'Ovulation occurs how long after LH surge?',
            'Options': [
                '10 - 12 hours',
                '24 - 36 hours',
                '34 - 38 hours',
            ...
            'id': 9,
            "question": 'What is the duration of luteal phase ?',
            'Options': [
                '5-10 days',
                '10-16 days',
                '15-30 days',
            ...
            'id': 10,
            "question": 'The luteal phase is also called ?',
            'Options': [
                'proliferative phase',
                'follicular phase',
                'secretory phase',
...
objXMLHttpRequest.open('GET', "haras5.php?s="+userscore+"&e=<?= $user_email; ?>", true);
objXMLHttpRequest.send();

   if(userscore >=500){
    alert("Sucessfully complited module 3");
