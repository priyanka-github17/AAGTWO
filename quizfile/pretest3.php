...
$exhib_id = '2d48451efc6a47ad0ee836d1e671acb4c81a16758ea2d0f7b2d20a13e7cddb66';
require_once "../exhibcheck.php";
$curr_room = 'pretest_module3';
?>
...
<img src="logo-new.png"  width="260px" height="98px" style="float:right"  alt="">
        </div> <p class="mod" >Module 3-Luteal Phase Defect<p>
...
<article class="result_box">
    <div class="score " ></div>
    <div id="replay"></div>
 <a href="../module3.php"><button  class="btn">Module 3-Luteal Phase Defect</button></a> 
...
<script>
    const questions = [{
            'id': 1,
            "question": 'Phases of menstrual cycle are',
            'Options': [
                '4',
                '2',
                '3',
            ...
            'id': 2,
            "question": 'Normal length of luteal phase in a non - fertile cycle is',
            'Options': [
                '6 days',
                '8-10 days',
                '10-12 days',
            ...
            'id': 3,
            "question": 'Heavy forms of exercise - upto 50% showed prolonged',
            'Options': [
                'follicular phase',
                'luteal phase',
                'none',
            ...
            'id': 4,
            "question": 'Clomiphene is not used as 1st line treatment modality for LPD',
            'Options': [
                'True',
                'False',
                'Maybe',
            ...
            'id': 5,
            "question": 'Progesterone supplementation in the luteal phase - 1st line management',
            'Options': [
                'True',
                'False',
                'Maybe',
...
objXMLHttpRequest.open('GET', "haras4.php?s="+userscore+"&e=<?= $user_email; ?>", true);
