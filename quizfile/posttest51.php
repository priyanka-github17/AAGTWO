...
<article class="result_box">
    ...
    <a href="../module22.php" ><button  class="btn1 mt-3">Re-Watch Module 2</button></a> 
 <!-- <a href="../digital_cert.php"><button  class="btn1">Next Module</button></a>  -->
 <a href="#" ><button  class="btn2"  id="myBtn">Module 4-Recurrent Implantation Failure</button></a> 
