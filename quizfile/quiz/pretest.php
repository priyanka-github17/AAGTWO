...
<style>
    ...
    * {
    ...
    body {
        ...
        height: 100vh;
        background-image:url(INTEGRACE.jpg);
...
<div class="container-fluid">
    <div class="row ">
        <div class="col-md-12 bg-white col-12 text-right">
<img src="AAG LOGO.png"  width="300px" height="120px"  alt="">
        </div>
    </div>
</div>
...
<article class="result_box">
    ...
    <a href="../module2.php"><button  class="btn">Click on Module 1</button></a> 
