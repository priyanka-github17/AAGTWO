...
<img src="logo-new.png"  width="260px" height="98px" style="float:right"  alt="">
        </div> <p class="mod" >Module 2 - Physiology of Conception<p>
...
<article class="result_box">
    <div class="score " ></div>
    <div id="replay"></div>
 <a href="../module2.php"><button  class="btn">Module 2 - PHYSIOLOGY OF CONCEPTION</button></a> 
...
<script>
    const questions = [{
            ...
            'id': 2,
            "question": 'The initial step during fertilization is ____________',
            'Options': [
            ...
            'answer': 'Fertilizin and antifertilizin reaction'
        }, {
            'id': 3,
            "question": 'Fertilization of sperm and ovum takes place in ____________',
            'Options': [
                'Fimbriae of oviduct',
                'Isthmus of oviduct',
                'Ampulla of oviduct',
            ...
            'answer': 'Ampulla of oviduct'
        }, {
            'id': 4,
            "question": 'In the absence of acrosome the sperm cannot',
            'Options': [
                'Get energy',
                'Penetrate into egg',
                'Get food',
            ...
            'answer': 'Penetrate into egg'
        }, {
            'id': 5,
            "question": 'The main function if fimbriae of oviduct are',
            'Options': [
                'Make necessary changes in endometrium for implantation',
                'Help in collection of ovum after ovulation',
                'Release ovum from Graafian follicle',
                'Help in devilment of embryo'
            ],
            'answer': 'Help in collection of ovum after ovulation'
        }
...
objXMLHttpRequest.open('GET', "haras2.php?s="+userscore+"&e=<?= $user_email; ?>", true);
