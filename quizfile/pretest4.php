...
<div class="container-fluid">
    <div class="row ">
        ...
        <p class="mod">Module 4-Recurrent Implantation Failure
        <p>
...
<article class="result_box">
    <div class="score "></div>
    <div id="replay"></div>
    <a href="../module4.php"><button class="btn">Module 4-Recurrent Implantation Failure</button></a>
...
<script>
    const questions = [{
            'id': 1,
            "question": 'RIF refers to failure to achieve clinical pregnancy after transfer of',
            'Options': [
                '4 embryos',
                '3 embryos',
                '2 embryos',
            ...
            'id': 3,
            "question": 'Most common age group affected:',
            'Options': [
                'less than 40yrs',
                'greater than 40years',
                '18-20years',
                '50years'
            ],
            'answer': 'less than 40yrs'
        }, {
            'id': 4,
            "question": 'In pregnancy',
            'Options': [
                'TH1 greater than TH2',
                'TH1 less than TH2',
                'TH1 equal to TH2',
                'None of the above'
            ],
            'answer': 'TH1 greater than TH2'
        }, {
            'id': 5,
            "question": 'Most common uterine anomaly',
            'Options': [
                'Bicornuate uterus',
                'Septate uterus',
                'Arcuate uterus',
    ...
    function result() {
        ...
        objXMLHttpRequest.open('GET', "haras6.php?s=" + userscore + "&e=<?= $user_email; ?>", true);
