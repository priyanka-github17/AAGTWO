...
$exhib_id = 'd96d7532f9c081e9963ec36c85c7dd43736dfbd4739138bc4ba3e13fd34a92d0';
require_once "../exhibcheck.php";
$curr_room = 'pretest_module5';
?>
...
<div class="container-fluid">
    <div class="row ">
        ...
        <p class="mod">Module 5-Investigations of Male and Female Infertility
        <p>
...
<article class="result_box">
    <div class="score "></div>
    <div id="replay"></div>
    <a href="../module5.php"><button class="btn">Module 5-Investigations of Male and Female Infertility</button></a>
...
<script>
    const questions = [{
            'id': 1,
            "question": 'An infertility evaluation is usually initiated',
            'Options': [
                'After 2 years of regular unprotected intercourse',
            ...
            'answer': 'after one year of regular unprotected intercourse'
        }, {
            'id': 2,
            "question": 'Initial assessment of infertility should include',
            'Options': [
                'Clinical history',
            ...
            'id': 3,
            "question": 'Genetic screening should be offered in accordance with risk as defined by ethnicity.',
            'Options': [
                'True',
                'False',
                'Maybe',
            ...
            'id': 4,
            "question": 'Home LH kits have a percent false positive and false negative rate',
            'Options': [
                '20 to 30',
                '10 to 20',
                '5 to 10',
            ...
            'id': 5,
            "question": 'The upper threshold for a normal FSH concentration is laboratory dependent; cutoff values are',
            'Options': [
                '5 to 10 milli-international units/mL',
                '10 to 25 milli-international units/mL',
                '30 to 40 milli-international units/mL',
                'None of above'
            ],
            'answer': '10 to 25 milli-international units/mL'
        }
    ...
    function result() {
        ...
        objXMLHttpRequest.open('GET', "haras8.php?s=" + userscore + "&e=<?= $user_email; ?>", true);
