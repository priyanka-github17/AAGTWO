...
<img src="AAG LOGO.png"  width="260px" height="98px"  alt="">
    ...
    <button id="start_quiz" style="background-color:#1977cc;">Start Pre-Test</button>
</header>
    </div>
</div>
...
<article class="result_box">
    <div class="score"></div>
    <!-- <div id="replay"></div> -->
 <!-- <a href="../module1.php"><button class="btn1">Click on Module 1</button></a>  -->

 <button id="replay" class="btn1 mt-3">Re-Try</button>
...
<script>
    const questions = [{
        ...
        //     ],
        //     'answer': 'Usually day 12; 48 hrs after the onset of mid-cycle LH surge'
        // }
    ...
    let userscore = 100; // correct answer select by user
        ...
        options_list.forEach((e) => {
            e.addEventListener('click', (op) => {
                if (op.target.innerHTML !== questions[active].answer) {
                    ...
                    for (let i = 100; i < options.children.length; i+=100) {
