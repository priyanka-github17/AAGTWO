...
$exhib_id = '8293952eac7a59f685e94090717f36c9bb614522c983deb62b1244417b8e50a3';
...
<img src="logo-new.png"  width="260px" height="98px" style="float:right"  alt="">
    ...
    <button id="start_quiz" style="background-color:#b30086;">ASSESSMENT 5 - INVESTIGATIONS OF MALE AND FEMALE INFERTILITY</button>
</header>
...
<section class="quiz_container">
    <div class="quiz_text">
        <h1>MODULE 5-INVESTIGATIONS OF MALE AND FEMALE INFERTILITY</h1>
    </div>
...
<article class="result_box">
    ...
    <a href="../module55.php" ><button  class="btn1 mt-3">Re-Watch Module 5</button></a> 
 <!-- <a href="../digital_cert.php"><button  class="btn1">Next Module</button></a>  -->
 <a  href="../quizfile/pretest6.php" ><button  class="btn2"  id="myBtn">Module 6-INTRAUTERINE INSEMINATION</button></a> 
...
<script>
    const questions = [{
            'id': 1,
            "question": 'Progesterone level is evidence of recent ovulation',
            'Options': [
                '>3 ng/mL',
                '<3ng/ml',
                'None of the above',
            ...
            'id': 2,
            "question": 'Ovulation is most easily documented by a',
            'Options': [
                'Estrogen level',
                'FSH levels',
                'LH levels',
            ...
            'answer': 'Mid-luteal phase serum progesterone level'
        }, {
            'id': 3,
            "question": 'A value of ------ suggestive of adequate ovarian reserve',
            'Options': [
                '<50pg/mL',
                '>80pg/mL',
                '<80 pg/mL',
            ...
            'id': 4,
            "question": 'AMH >1.0 ng/mL but <3.5 ng/mL suggests',
            'Options': [
                'less than three follicles',
                'good response to stimulation',
                'limited eggs',
                'vigorous response to stimulation'
            ],
            'answer': 'good response to stimulation'
        }, {
            'id': 5,
            "question": 'AMH can be measured',
            'Options': [
                'mid-menses',
                'day 3 of cycle',
            ...
            'answer': 'anytime during the menstrual cycle'
        }, {
            'id': 6,
            "question": 'Routine testing for antiphospholipid, antisperm, antinuclear, and antithyroid antibodies is not supported by existing data',
            'Options': [
                'True',
                'False',
                'Maybe',
            ...
            'id': 7,
            "question": 'Over 80 percent of infertile men have',
            'Options': [
                'low sperm concentrations',
                'poor sperm quality',
                'increase in spermatozoa with abnormal morphology',
                'All the above'
            ],
            'answer': 'All the above'
        }, {
            'id': 8,
            "question": 'Loss of pubic, axillary, and facial hair, decreased oiliness of the skin, and fine facial wrinklingin men suggest longstanding',
            'Options': [
                'estrogen excess',
                'estrogen deficiency',
            ...
            'answer': 'testosterone deficiency'
        }, {
            'id': 9,
            "question": '_____  is the key laboratory assessment of the male partner of an infertile couple',
            'Options': [
                'Serum testosterone',
                'Semen analysis',
                'USG',
            ...
            'id': 10,
            "question": 'Karyotyping is recommended for infertile men with elevated serum FSH and LH concentrations and a sperm concentration less than',
            'Options': [
                '10 million/mL',
                '5 million/mL',
                '1 million/mL',
...
objXMLHttpRequest.open('GET', "haras9.php?s="+userscore+"&e=<?= $user_email; ?>", true);
objXMLHttpRequest.send();

   if(userscore >=800){
    alert("Sucessfully complited module 5");
