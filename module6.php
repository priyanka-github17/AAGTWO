...
$exhib_id = '50f438a59ea82e11e9c986a1b024bc98fd6e4e0decc4b6fe0b7944ab184dba09';
...
<video id="myVideo" width="900" height="500" controls>
    ...
    <video id="myVideo"  style="width: 100%;height: auto;" controls controlsList="nodownload" disablePictureInPicture>
      ...
      <source src="https://player.vimeo.com/progressive_redirect/playback/725663627/rendition/720p/file.mp4?loc=external&signature=0025c6cece1a6ab684a619aa0b6db18ff0634aa345bfb454cd8e80ba774a2b85
" type="video/mp4" />
  ...
  <div class="col-md-8">
    ...
    <div class="row">
      ...
      <div class="course-name-hld ml-2">
          ...
          <div>
              <span class="course-name mb-4">INTRAUTERINE INSEMINATION</span>
              ...
              <a href="quizfile/posttest6.php"><button class="cmeFormButton btn mb-2 mr-2"  id="btn1"  data-modal="enroll-with-login"> POST ASSESSMENT</button></a> 
          ...
          <!-- <div class="course-social-hld text-right ">
                    ...
                    <div id="toggle">
                        <!-- <p>Note:</p> -->
                        <p dir="ltr">Module 6 teaches you everything about IUI. The participant will be able to gain knowledge on all points including patient selection- male and female partners, contraindications, prognostic factors, screening, stimulation, clomiphene citrate, letrozole, combination of Cc + Gn, dosage, step up, step down, sequential protocol, cancellation of cycle, monitoring, trigger and timing, sperm preparation, methodology of IUI, complications, LPS and follow up, failure of IUI.</p>
