...
<div class="page-content">
    <div id="content">
        ...
        <div id="bg" class="esoz">
            <img src="assets/img/stalls/esoz.jpg">
            <div id="back-button">
                <a href="exhibitionhalls.php"><i class="fas fa-arrow-alt-circle-left"></i> Back</a>
            </div>
            <a href="assets/resources/esoz_1.jpg" id="poster1" class="view">
                <div class="indicator d-6"></div>
            </a>
            <a href="assets/resources/esoz_2.jpg" id="poster2" class="view">
                <div class="indicator d-6"></div>
            </a>
