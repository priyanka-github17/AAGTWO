...
$exhib_id = '9dbde90ff32682f2c3994868528840a826d5ac1cd9526420343bbc2b4764ebcb';
...
<video id="myVideo" width="900" height="500" controls>
    ...
    <video id="myVideo"  style="width: 100%;height: auto;" controls controlsList="nodownload" disablePictureInPicture>
      ...
      <!-- <source src="https://player.vimeo.com/progressive_redirect/playback/720548951/rendition/720p/file.mp4?loc=external&signature=e8d185fa596c8f614f3d4c09ffaa3eea65cfaab43a83a684802b707539b0c86a" type="video/mp4" /> -->
      <source src="https://player.vimeo.com/progressive_redirect/playback/725640612/rendition/720p/file.mp4?loc=external&signature=e186f124df4c32dd2939acf33295350c33c5a285089863a70db08217dcbb504e" type="video/mp4" />
  ...
  <div class="col-md-8">
    ...
    <div class="row">
      ...
      <div class="course-name-hld ml-2">
          ...
          <div class="course-shortname">Live On 1st July 22</div>

          <div class="course-name-start mb-3">
          <div>
              <span class="course-name mb-4">INVESTIGATIONS OF MALE AND FEMALE INFERTILITY</span>
              <!-- <span class="course-speaker">Speaker: <a target="_blank" href="/speaker/1/afg/628f41adef6c5d071810fb76" class="name">AFG</a></span> -->
              <a href="lobby.php"><button class="cmeFormButton btn mb-2 mr-2"  id="btn1"  data-modal="enroll-with-login"> HOME </button></a> 
              <a href="quizfile/posttest5.php"><button class="cmeFormButton btn mb-2 mr-2"  id="btn1"  data-modal="enroll-with-login"> POST ASSESSMENT</button></a> 
          ...
          <!-- <div class="course-social-hld text-right ">
                    ...
                    <div class="course-desc-hld">
                        ...
                        <div class="description ddd-truncated" style=""><p>All About Gestation - A foundation Course on Infertility Management</p><p>Date: 1st July 2022 (Friday)</p><p>Time: 10 AM Onwards (Indian Standard Time +05.30 GMT)</p>
                    ...
                    <div id="toggle">
                        <!-- <p>Note:</p> -->
                        <p dir="ltr">Module 5 will take the participant through Investigations of male and female infertility. This module will cover all topics including initial assessment, physical examination, examination of uterus, diagnostic approach to infertility in woman, test for ovulatory function, test for ovarian reserve, AMH levels and advantages, tubal evaluation test, tests of limited clinical utility, investigations of male infertility, semen analysis-prerequisites, additional tests, endocrine testing, scrotal and transrectal ultrasound.</p>
